...
public final class FlipCubeService extends WallpaperService {
	...
	private final class WallpaperEngine extends Engine {
		...
		private FlipCubeRenderer mRenderer;
		...
		public void onCreate(SurfaceHolder surfaceHolder) {
			...
			mRenderer = new FlipCubeRenderer(FlipCubeService.this);
